      ...
      <div className="p-4 border-t border-dark-700 space-y-2">
        ...
        {user && (
          <div className="flex items-center gap-2 px-3 py-2 mt-2">
            <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-primary-500 to-cyan-500 flex items-center justify-center text-white font-bold text-xs shrink-0">
