...
import YouTubeIcon from '../components/youtube/YouTubeIcon'
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <button 
                type="button"
                onClick={() => window.open('https://youtube.com/@mohitdecodes', '_blank', 'noopener,noreferrer')} 
                className="btn-secondary py-3 px-6 sm:py-3.5 sm:px-8 font-semibold rounded-xl flex items-center gap-2.5 border border-slate-300 dark:border-dark-700 bg-white/80 dark:bg-dark-900/60 hover:bg-slate-100 dark:hover:bg-dark-800 transition-all cursor-pointer shadow-sm"
              >
        ...
        <section className="py-20 border-t border-white/5">
          <div className="container-max text-center">
            ...
            <div className="marquee-container py-4 relative">
              {/* Side fades */}
              <div className="absolute inset-y-0 left-0 w-16 md:w-32 bg-gradient-to-r from-[#060814] to-transparent z-10 pointer-events-none" />
              <div className="absolute inset-y-0 right-0 w-16 md:w-32 bg-gradient-to-l from-[#060814] to-transparent z-10 pointer-events-none" />
