                  ...
                  {profileDropdownOpen && (
                    ...
                    >
                      ...
                      <div className="flex items-start mb-3">
                        <div className="w-12 h-12 rounded-full bg-primary-600/20 border border-primary-500/30 flex items-center justify-center text-white text-lg font-extrabold overflow-hidden shrink-0 mr-3">
                          {user?.avatar ? <img src={user.avatar} className="w-full h-full object-cover" /> : user?.name?.charAt(0).toUpperCase()}
                        </div>
